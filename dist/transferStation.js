...
var a = require("./repairData");

var repairData = a.repairData;
var tokenObj = a.tokenObj;

var jwt = require("jsonwebtoken");
var getSqlData = require("./sqlfn").getSqlData;

exports.transferStation = function (req, res, resHeaders) {
    //目的区分 /login /login/?a=1&b=2  /login/2 
    var url = req.url;
    var firstRepairName = url.substring(url.lastIndexOf("/") + 1, url.lastIndexOf("?") + 1 ? url.lastIndexOf("?") : undefined);

    var secondRepaiUrl = url.substr(0, url.lastIndexOf("/"));

    var secondRepaiName = secondRepaiUrl.substr(secondRepaiUrl.lastIndexOf("/") + 1);
